...
/*  if($_SERVER["REQUEST_METHOD"] === "POST")
 {
     $recaptcha_secret = "6Ldl-H0lAAAAAPVNYajAehFgyRduL0SyqbcSvUrc";
...
<div class="container">
    <div class="margin-bottom-lg margin-top-lg clearfix" style="padding-top:20px; padding-bottom:20px;">
       ...
       <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4523.774945642282!2d-82.97057702982265!3d42.676078185923195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8824e0ef31aff76f%3A0x79a4715e74cc60ac!2s911%20Mechanical%20Heating-Cooling-Plumbing!5e0!3m2!1sen!2sus!4v1709617562824!5m2!1sen!2susGoogle"  height="260"  style="border:0; width:100% " allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" ></iframe>
       </div> -->
            ...
            <br>
            <p><strong>If after normal business hours, emails won't be answered until the next business day, if you need
                    emergency service, please Call (888) 508-4911</strong></p>
            <br>
            <form action="<?php echo $base_url; ?>/contact-us.php" method="POST" class="form-horizontal">
             ...
             ?>
                ...
                <!--   <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="g-recaptcha" data-sitekey="6Ldl-H0lAAAAAOUbZWGCtN8qIUdRPxEgPXolbObd"></div>
                    </div>
                </div>
                <br> -->
